...
$context["action"], "type", array(), "any", true, true) && ($this->getAttribute($context["action"], "type", array()) == "button"))) {
    ...
    {
        return new Twig_Source("", "PrestaShopBundle:Admin/Helpers:bootstrap_popup.html.twig", "/Library/WebServer/Documents/src/PrestaShopBundle/Resources/views/Admin/Helpers/bootstrap_popup.html.twig");
    }
}
