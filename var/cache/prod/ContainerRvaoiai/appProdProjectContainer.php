...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_b553d9f664a9628bb3e93c45b5ac1f860a5c0d35db5437dbe5a57bbb50ae49d7');
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2SChy3SVV4oIMC12gRRiuzsKRHXSvm1Vrhgk8zfyzi2BLZFL0QLIy7NC')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2SChy3SVV4oIMC12gRRiuzsKRHXSvm1Vrhgk8zfyzi2BLZFL0QLIy7NC');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.active_modules' => array(
                ...
                65 => 'dateofdelivery',
                66 => 'ps_viewedproduct',
                67 => 'statsbestmanufacturers',
                68 => 'trackingfront',
                69 => 'ps_emailsmanager',
                70 => 'ps_googleanalytics',
                71 => 'ps_legalcompliance',
                72 => 'pspixel',
                73 => 'ps_emailalerts',
                74 => 'ps_advertising',
                75 => 'ps_newproducts',
            ...
            'database_port' => '',
            'database_name' => 'zimeasyshoppingdbstag',
            'database_user' => 'root',
            'database_password' => 'jabulani',
            'database_prefix' => 'ps_',
            ...
            'secret' => '2SChy3SVV4oIMC12gRRiuzsKRHXSvm1Vrhgk8zfyzi2BLZFL0QLIy7NC',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-09-29',
            'locale' => 'en-US',
            'cookie_key' => 'WbdLw2AsNzd9sS6yXcbGQrDhprgtGMMoOYgxR3BfUoS45S3dDbWcjpM6',
            'cookie_iv' => 'ZkXi20HO',
            'new_cookie_key' => 'def0000066736779be33a1e2ea0408e78b3f4347595ebe11f73c988e04dab99bc13c50abe1e457c056c97606fcf950ed18df009f109b08281e76a9a9df06d7f064f0a6dd',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => '2SChy3SVV4oIMC12gRRiuzsKRHXSvm1Vrhgk8zfyzi2BLZFL0QLIy7NC',
